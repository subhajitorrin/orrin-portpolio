...
function Section5({ index }) {
  ...
  return (
    <div className="h-screen  mb-[15rem] flex items-center justify-center flex-col gap-[10rem]">
      <h4 className="text-[70px] text-white tracking-[-5px] monospace text-center leading-[85%]">
        Some of the techs I like <br />{" "}
        <span style={{ color: colorArr[index] }}>to work with</span>
      </h4>
      <div
        id="Dragbox5"
        className="rounded-[5px] overflow-hidden text-[20px] text-white h-[400px] w-[60%] border border-[#404140] "
      >
