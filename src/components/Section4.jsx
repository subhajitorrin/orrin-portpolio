    ...
    return (
      <div className=" w-full flex justify-center mb-[1rem] mt-[-10rem]">
        <div className="gap-[2rem] flex-col flex w-[90%] border border-[#404140] rounded-[10px] p-[2rem] monospace">
          ...
          <div className="text-white h-full flex justify-end flex-col text-right ">
            <p className="text-[7vw] cursor-pointer monospace opacity-[.7] hover:opacity-[1] transition-all duration-300 ease-linear">
              → SEND ME AN EMAIL
            </p>
            <p className="text-[15px] opacity-[0.5] monospace">
              LOCAL TIME ► {formattedTime}
          ...
          <div className="">
            <p className="text-white opacity-[.3] text-[10px] text-end">
              Made by Subhajit Ghosh
            </p>
          </div>
        </div>
